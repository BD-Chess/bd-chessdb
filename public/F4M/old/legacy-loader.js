...
const SWITCH='<nav class="bd-version-nav" aria-label="Flip4M versions"><a href="../">CURRENT</a><a class="active" aria-current="page" href="./">PREVIOUS</a><a href="../new/">LAB</a><a href="../PWA/">PWA</a></nav>';
...
fetch('F4M.html',{cache:'no-store'}).then(r=>{if(!r.ok)throw Error('HTTP '+r.status);return r.text();}).then(html=>{
 html=html.replaceAll('href="F4M_paper.html"','href="../f4m/"');
