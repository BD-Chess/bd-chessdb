...
function context() {
  ...
  const c = {
    ...
    // Optional study/evidence UI is absent in this isolated lifecycle harness.
    offlineEvidence: null, lastDecision: null, studyUI: null, acknowledgedAutoPauses: new Set(),
    simRequests: new Set(),
