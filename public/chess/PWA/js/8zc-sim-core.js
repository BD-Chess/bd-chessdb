...
(function (root, factory) {
  ...
  function toPGN(Chess, run) {
    ...
    const tags = {
      Event: run.eventName || ((run.tournamentId || run.eventId) ? 'ChessBest LAB tournament' : 'ChessBest position experiment'), Site: 'https://bd-chess.github.io/bd-chessdb/chess/PWA/',
