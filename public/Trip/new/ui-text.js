...
(() => {
  ...
  const words={
    ...
    "Start or recover a Deep run to inspect its diagnostics.":"Za pregled diagnostike zaženi ali obnovi izračun Deep.",
    "Elapsed time":"Pretečeni čas",
    "Budget used":"Porabljeni proračun",
    "Remaining budget":"Preostali proračun",
    "Worker compute time — sum":"Računski koraki — vsota delavcev",
    "Explicit pauses":"Izrecni premori",
    "Budget overrun":"Presežek proračuna",
    "Local initialization":"Lokalna inicializacija",
    "Checkpoint storage":"Hramba kontrolne točke",
    "Diagnostic work":"Diagnostično delo",
    "Finalization":"Zaključevanje",
    "Include reproduction input":"Vključi podatke za ponovitev",
    "Export diagnostics (.zip)":"Izvozi diagnostiko (.zip)",
    "Cancel export":"Prekliči izvoz",
    "Budget / observed time":"Proračun / opazovani čas",
    "Observed wall time":"Opazovani pretečeni čas",
    "Mixed legacy / elapsed time":"Mešani stari / pretečeni čas",
    "Mixed timing":"Mešano merjenje časa",
    "Candidates ready / completed":"Pripravljeni / dokončani kandidati",
    "Budget used; saving…":"Proračun porabljen; shranjujem …",
    "Logs stay on this device. Export only downloads a file when you click; nothing is uploaded.":"Dnevniki ostanejo na tej napravi. Izvoz ob tvojem kliku prenese datoteko; ničesar ne nalaga drugam.",
    "Worker compute time is the measured sum of instrumented sections, not OS CPU time. With several workers it can exceed elapsed time. Concurrent timings overlap and must not be added as a breakdown of one minute.":"Čas računskih korakov je izmerjena vsota opazovanih odsekov, ne čas CPU iz operacijskega sistema. Pri več delavcih lahko preseže pretečeni čas. Sočasne meritve se prekrivajo in jih ne seštevamo kot razrez ene minute.",
    "Off by default. Reproduction input may contain private coordinates or the road matrix; no stop names, passwords or API credentials are included.":"Privzeto izključeno. Podatki za ponovitev lahko vsebujejo zasebne koordinate ali cestno matriko; imen postankov, gesel in dostopnih podatkov API ni v izvozu.",
    "Mixed timing: the saved legacy time keeps its original meaning. New continuation uses elapsed time minus explicit pauses.":"Mešano merjenje: shranjeni stari čas ohrani svoj prvotni pomen. Novo nadaljevanje meri pretečeni čas brez izrecnih premorov.",
    "Ordinary Deep: observed wall time includes dispatch and result-delivery latency. Its existing deadline is unchanged; hidden tabs do not pause this mode. Internal compute time is unavailable.":"Navadni Deep: opazovani čas vključuje pošiljanje ukaza in prejem rezultata. Dosedanji rok ostaja enak; skrit zavihek tega načina ne ustavi. Notranji računski čas ni na voljo.",
    "Elapsed time contains observed segments only; closed-page gaps and an uncommitted tail are uncertain. Budget excludes closed time.":"Pretečeni čas zajema le opazovane odseke; čas zaprte strani in neshranjeni konec sta negotova. Zaprta stran ne porablja proračuna.",
    "Budget includes local preparation, worker scheduling, checkpoint storage and diagnostics. Only explicit pauses are excluded. Hidden tabs pause MDLxDCC.":"Proračun vključuje lokalno pripravo, razporejanje delavcev, hrambo stanja in diagnostiko. Izključeni so le izrecni premori. Skrit zavihek ustavi MDLxDCC.",
    "Basic diagnostics ON · internal method details unavailable.":"Osnovna diagnostika VKLOPLJENA · notranje podrobnosti metod niso na voljo.",
    "Diagnostics OFF · coverage gaps are recorded.":"Diagnostika IZKLOPLJENA · vrzeli pokritosti so označene.",
    "Partial diagnostic coverage; inspect the exported summary.":"Delna diagnostična pokritost; podrobnosti so v izvoženem povzetku.",
    "Diagnostics ON · the export states sequence coverage and gaps.":"Diagnostika VKLOPLJENA · izvoz navaja pokritost zaporedja in vrzeli.",
    "Ordinary diagnostics are in memory only; export before closing this page.":"Diagnostika navadnega Deep je samo v pomnilniku; izvozi jo pred zaprtjem strani.",
    "Diagnostics are in memory only; keep this page open and export.":"Diagnostika je samo v pomnilniku; ohrani stran odprto in izvozi podatke.",
    "Encrypted diagnostics saved on this device.":"Šifrirana diagnostika je shranjena na tej napravi.",
    "Diagnostic storage is partial; inspect coverage in the export.":"Hramba diagnostike je delna; preveri pokritost v izvozu.",
    "Diagnostic storage status is included in the export.":"Stanje hrambe diagnostike je navedeno v izvozu.",
    "Road matrix and numeric node order":"Cestna matrika in številčni vrstni red točk",
    "Original public TSP coordinates and numeric node order":"Izvirne javne koordinate TSP in številčni vrstni red točk",
    "Private geographic coordinates and numeric node order":"Zasebne geografske koordinate in številčni vrstni red točk",
    "Estimated input size:":"Ocenjena velikost vhoda:",
    "Input will be included.":"Vhod bo vključen.",
    "Input will be omitted.":"Vhod ne bo vključen.",
    "Preparing a diagnostic snapshot; calculation continues.":"Pripravljam diagnostični posnetek; računanje se nadaljuje.",
    "Diagnostics exported. The ZIP is a snapshot, not a solver checkpoint.":"Diagnostika je izvožena. ZIP je diagnostični posnetek, ne kontrolna točka solverja.",
    "Export cancelled. Calculation is unchanged.":"Izvoz je preklican. Računanje ostaja nespremenjeno.",
    "Diagnostic export failed. Calculation is unchanged; try again.":"Izvoz diagnostike ni uspel. Računanje ostaja nespremenjeno; poskusi znova.",
    "Diagnostic setting was not applied. Calculation is unchanged.":"Nastavitev diagnostike ni bila potrjena. Računanje ostaja nespremenjeno.",
    "Same stops, START and distance units are required. MDLxDCC reports elapsed budget including local overhead, minus explicit pauses. Ordinary Deep reports observed wall time, including message latency. Worker compute time is separate. Mixed legacy timing is not comparable. External Google data fetching is separate.":"Potrebni so isti postanki, START in enote razdalje. MDLxDCC poroča o pretečenem proračunu z lokalno režijo, brez izrecnih premorov. Navadni Deep poroča o opazovanem času z zakasnitvijo sporočil. Računski čas delavcev je ločen. Mešani stari čas ni primerljiv. Pridobivanje Googlovih podatkov je ločeno.",
    "Ordinary Deep retains its existing elapsed-time budget. Observed wall time and timing limitations are shown in Diagnostics.":"Navadni Deep ohrani dosedanji pretečeni časovni proračun. Opazovani čas in merilne omejitve so v razdelku Diagnostika.",
    "running":"računanje",
    "preparing":"priprava",
    "paused_user":"uporabnikov premor",
    "paused_hidden":"premor zaradi skritega zavihka",
    "paused_budget":"proračun porabljen",
    "pausing":"ustavljanje",
    "saving":"shranjevanje",
    "restore":"obnova",
    "user_or_terminal":"uporabniški ali zaključni premor",
    "cancel":"preklic",
    "hidden":"skrit zavihek",
    "budget":"proračun",
    "optimum":"optimum",
    "error":"napaka",
...
"Planar distances (TSP)":"Ravninske razdalje (TSP)","Planar TSP (EUC_2D)":"Ravninske razdalje TSP (EUC_2D)","Known optima source":"Vir znanih optimumov","Checking the original TSP reference…":"Preverjanje izvirne reference TSP …","Complete original round trip · reference applies.":"Celotna izvirna povratna pot · referenca velja.","Reference only: requires the complete original dataset, Planar TSP and Round Trip.":"Samo referenca: potrebni so celoten izvirni seznam, Ravninske razdalje TSP in Povratna pot.","Known optimum reached · gap 0%":"Znani optimum dosežen · odstopanje 0 %","TSP points adapted for Maps. Direct Line uses great-circle kilometres, not the original EUC_2D benchmark score. Duplicate locations keep their node IDs.":"Točke TSP so prilagojene zemljevidu. Zračna linija uporablja kilometre po velikem krogu. Za izvirno metriko vključi Ravninske razdalje TSP.","TSP loads Planar distances by default: original rounded EUC_2D units, not kilometres. Turn off Planar distances to use great-circle kilometres. Duplicate locations keep their node IDs.":"TSP privzeto vključi ravninske razdalje: izvirne zaokrožene enote EUC_2D, ne kilometrov. Za kilometre po velikem krogu odznači ravninske razdalje. Ponovljene lokacije ohranijo oznake točk.","Showing the TSP route on Maps; cost uses original EUC_2D units.":"Prikazana je pot TSP na zemljevidu; izračun uporablja izvirne enote EUC_2D.","Planar TSP: optimization uses original EUC_2D costs, not kilometres.":"Ravninski TSP: optimizacija uporablja izvirne vrednosti EUC_2D, ne kilometrov.","TSP loaded with Planar distances. Choose Fast or Deep to calculate locally.":"TSP je naložen z ravninskimi razdaljami. Za lokalni izračun izberi hitro ali poglobljeno optimizacijo.","TSP stops were changed. Reload the collection or turn off Planar distances (TSP).":"Točke TSP so spremenjene. Znova naloži zbirko ali odznači Ravninske razdalje (TSP).","Select a TSP collection to use Planar distances (TSP).":"Za ravninske razdalje TSP izberi zbirko TSP.","Original TSP checksum does not match.":"Kontrolna vsota izvirnika TSP se ne ujema.","TSP reference download failed. Please try again.":"Prenos reference TSP ni uspel. Poskusi znova.","TSP reference does not match this dataset.":"Referenca TSP ne ustreza tej zbirki.","Invalid original TSP dataset.":"Neveljavna izvirna zbirka TSP.","Original TSP coordinates are required.":"Potrebne so izvirne koordinate TSP.","Reduction versus the entered order, using original rounded EUC_2D costs.":"Prihranek glede na vneseni vrstni red z izvirnimi zaokroženimi vrednostmi EUC_2D.","Same stops and START. Each row states its distance units. Fast and Deep report the best route found. Completed Brute Force proves the table optimum. A matching known TSP optimum applies only to the complete original EUC_2D round trip. Times exclude data preparation and map drawing.":"Isti postanki in START. Vsaka vrstica navaja svoje enote. Hitra in poglobljena metoda poročata o najboljši najdeni poti. Končan Brute Force dokaže optimum matrike. Ujemanje z znanim optimumom TSP velja le za celotno izvirno povratno pot EUC_2D. Časi ne vključujejo priprave podatkov in risanja zemljevida.",
  ...
  const fragments={
    'paused_hidden':'premor zaradi skritega zavihka','paused_user':'uporabnikov premor','paused_budget':'proračun porabljen','preparing':'priprava','running':'računanje','pausing':'ustavljanje','saving':'shranjevanje',
    ' older events compacted.':' starejših dogodkov je zgoščenih.',
    "Diagnostics":"Diagnostika",
    "Record local diagnostics":"Beleži lokalno diagnostiko",
    "Elapsed time":"Pretečeni čas",
    "Budget used":"Porabljeni proračun",
