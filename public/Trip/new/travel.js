/* 8Z Trip LAB · travel view v1. Route is copied by an explicit action in LAB. */
(function () {
  'use strict';
  const ROUTE_KEY = '8z_trip_travel_route_v1';
  const PROGRESS_KEY = '8z_trip_travel_progress_v1';
  const $ = id => document.getElementById(id);
  const words = {
    en: {
      back: 'Trip LAB', title: 'On the road', emptyTitle: 'No route saved for travel',
      emptyBody: 'Optimize a trip in LAB, then choose “On the road” from its route results.',
      ...
      visited: 'Mark stop visited ✓', stops: 'Stops', backToPlan: '← Back to Trip LAB',
    ...
    sl: {
      back: 'Trip LAB', title: 'Na poti', emptyTitle: 'Ni shranjene poti za uporabo na poti',
      emptyBody: 'V LAB optimiziraj pot in nato pri rezultatih izberi »Na poti«.',
      ...
      visited: 'Označi kot obiskano ✓', stops: 'Postaje', backToPlan: '← Nazaj v Trip LAB',
  ...
  function savedRoute() {
    ...
    if (!raw || raw.version !== 1 || raw.source !== 'lab' || !Number.isSafeInteger(raw.savedAt) ||
  ...
  function init() {
    ...
    window.addEventListener('pageshow', () => {
      // LAB may have replaced the route while this PWA page was in the back stack.
