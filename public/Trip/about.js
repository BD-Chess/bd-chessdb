...
window.ABOUT_CONTENT = `
  ...
  <div class="card help-block">
    <details style="cursor:pointer; background:rgba(0,0,0,0.2); padding:10px; border-radius:8px;">
      <summary style="font-weight:700; color:var(--primary);">💡 The "8Z" Insight (Learn More)</summary>
      <div style="margin-top:10px; padding-left:10px; border-left:2px solid var(--primary);">
        <p>I realized that <strong>route optimization is actually a data compression problem.</strong></p>
