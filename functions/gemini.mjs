...
function optimizationInstructions(guiVersion) {
  if (guiVersion === LAB_VERSION) return optimizationInstructions('road-matrix-brute16-lab').replaceAll('2–16','2–20').replaceAll('Above 16','Above 20');
  if (guiVersion === 'road-matrix-brute16-lab') return optimizationInstructions('road-matrix-brute15').replaceAll('2–15','2–16').replaceAll('Above 15','Above 16').replace('approximate straight-line distances','great-circle surface distances on a sphere') + ' Calculation comparison adds Our Optimize (Deep · Air), independently optimized with great-circle costs. Do not compare its kilometers against a road optimum. Demo shows historical EU14/EU15 measurements; they do not prove Fast or Deep always finds the optimum.';
