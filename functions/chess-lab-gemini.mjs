import { chessKnowledge } from './_shared/chess-lab-knowledge.mjs';
...
export default async req => {
  ...
  if (req.method === 'GET') return json({ ok: true, configured: Boolean(key), model, knowledgeVersion: 'chess-lab-20260913-v2' });
  ...
  try {
    ...
    return json({ ok: true, text, truncated: candidate.finishReason === 'MAX_TOKENS', model: data.modelVersion || model,
      fen: snapshot.fen, snapshotAt: snapshot.capturedAt, knowledgeVersion: 'chess-lab-20260913-v2' });
  } catch (err) {
